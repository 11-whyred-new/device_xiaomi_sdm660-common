...
git clone https://github.com/ini23/android_kernel_xiaomi_sdm660_southwest -b 11.0-eas-wifi-r kernel/xiaomi/sdm660
git clone https://github.com/dotMod/android_packages_services_Telecomm -b dot11 packages/services/Telecomm
git clone https://github.com/dotMod/android_hardware_qcom_thermal -b dot11.0 hardware/qcom/thermal
